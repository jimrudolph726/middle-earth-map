...
export const gandalfthewhitecampsites = {
  ...
  February17: { coords: [44.94468224,-93.30447087], icon: icons.TentIcon, popup: createCampsitePopup('February 17','?','?','?','Gwaihir carries Gandalf to Lothlorien', 'Lothlorien'),
    },
  February18: { coords: [44.94466539,-93.30446414], icon: icons.TentIcon, popup: createCampsitePopup('February 18','?','?','?','Galadriel arrays Gandalf in white and places a new staff in his hand.', 'Lothlorien'),
    },
  February20: { coords: [44.9440813,-93.3046144], icon: icons.TentIcon, popup: createCampsitePopup('February 20','?','?','?','Gandalf leaves Lothlorien and is flown south by Gwaihir.', 'Lothlorien'),
    },
