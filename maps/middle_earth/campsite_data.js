...
export const samfrodocampsites = {
    September23: { coords: [44.94641168,-93.31107933], icon: icons.TentIcon, popup: createCampsitePopup('September 23',5,18,3.6,'Evening march.','Green Hill Country'),
    },
    September24: { coords: [44.94645099,-93.31071943], icon: icons.TentIcon, popup: createCampsitePopup('September 24',8,28,3.5,'Black Riders, Elves.','West of Woodhall'),
    },
    September25: { coords: [44.94651850,-93.31053838], icon: icons.TentIcon, popup: createCampsitePopup('September 25',7.5,27,10.4,'Marish, Farmer Maggot wagon, Buckland.','Crickhollow'),
    },
    September26: { coords: [44.94648852,-93.31026257], icon: icons.TentIcon, popup: createCampsitePopup('September 26',10.5,25,2.4,'On ponies. Knoll, Old Man Willow.','The House of Tom Bombadil'),
    },
    September27: { coords: [44.94649785,-93.31021864], icon: icons.TentIcon, popup: createCampsitePopup('September 27'," "," "," d",'Rain.','The House of Tom Bombadil'),
    },
    ...
    September30: { coords: [44.94685673,-93.30960176], icon: icons.TentIcon, popup: createCampsitePopup('September 30',7.5,11,1.5,'Joined by Strider. Depart 10A.M. Wandering course.','Western Chetwood'),
    },
    October1: { coords: [44.94683897,-93.30946871], icon: icons.TentIcon, popup: createCampsitePopup('October 1',11,16,1.5,'Turn due east.','Eastern Chetwood'),
    },
    October2: { coords: [44.94679721,-93.30929990], icon: icons.TentIcon, popup: createCampsitePopup('October 2',11,16,1.5,'','Midgewater Marshes'),
    },
    ...
    October4: { coords: [44.9467568,-93.3088945], icon: icons.TentIcon, popup: createCampsitePopup('October 4',11,17,1.5,'','Stream from Hills'),
    },
    October5: { coords: [44.9467950,-93.3085619], icon: icons.TentIcon, popup: createCampsitePopup('October 5',11.5,18,1.6,'','Weather Hills'),
    },
    October6: { coords: [44.9466244,-93.3085682], icon: icons.TentIcon, popup: createCampsitePopup('October 6',4,12,3,'Climb hill at noon. Attacked at moonrise.','Dell by Weathertop'),
    },
    October7: { coords: [44.9463597,-93.3083197], icon: icons.TentIcon, popup: createCampsitePopup('October 7',11,19,1.7,'Frodo on pony.','Thickets south of Road'),
    },
    October8: { coords: [44.9463642,-93.3081628], icon: icons.TentIcon, popup: createCampsitePopup('October 8',11,19,1.7,'Frodo on pony.','Thickets south of Road'),
    },
    October9: { coords: [44.9463873,-93.3079795], icon: icons.TentIcon, popup: createCampsitePopup('October 9',11,19,1.7,'Frodo on pony.','Thickets south of Road'),
    },
    October10: { coords: [44.9464255,-93.3077260], icon: icons.TentIcon, popup: createCampsitePopup('October 10',11,19,1.7,'Frodo on pony.','Thickets south of Road'),
    },
    October11: { coords: [44.9464876,-93.3073357], icon: icons.TentIcon, popup: createCampsitePopup('October 11',11,19,1.7,'Frodo on pony.','Thickets south of Road'),
    },
    October12: { coords: [44.9466875,-93.3070558], icon: icons.TentIcon, popup: createCampsitePopup('October 12',11,19,1.7,'Frodo on pony.','SW of Last Bridge'),
    },
    ...
    October16: { coords: [44.9469664,-93.3067884], icon: icons.TentIcon, popup: createCampsitePopup('October 16',11,8,0.7,'Turn more north.','Shallow Cave'),
    },
    October17: { coords: [44.9468412,-93.3067232], icon: icons.TentIcon, popup: createCampsitePopup('October 17',6,5,0.8,'Turn southeast.','Top of Ridge'),
    },
    October18: { coords: [44.9467008,-93.3063604], icon: icons.TentIcon, popup: createCampsitePopup('October 18',21,34,1.6,'Find Trolls. Meet Glorfindel, march until dawn.','No campsite'),
    },
    October19: { coords: [44.9466715,-93.3059500], icon: icons.TentIcon, popup: createCampsitePopup('October 19',9,20,2.2,'Frodo on horse.','Central Trollshaws'),
    },
    October20throughDecember24: { coords: [44.94675556,-93.30550447], icon: icons.TentIcon, popup: createCampsitePopup('October 20 through December 24',9,18,2,'March to Ford. Attack by Black Riders. Stay in Rivendell for two months.','Rivendell'),
    },
