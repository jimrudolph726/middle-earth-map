...
export const gandalfthewhitecampsites = {
  ...
  March14: { coords: [44.940888662404646, -93.300740130806332], icon: icons.TentIcon, popup: createCampsitePopup('March 14'," "," "," ",`Minas Tirith is besieged. Gandalf takes charge of the City's defenses.`,'Minas Tirith'), 
   },
  March15: { coords: [44.940888662404646, -93.300740130806332], icon: icons.TentIcon, popup: createCampsitePopup('March 15'," "," "," ",`Battle of the Pelennor Fields. Gandalf confronts the Lord of the Nazgul at the gates of Minas Tirith. He saves Faramir from his father's funeral pyre but Denethor dies.`,'Minas Tirith'), 
   },
  March16: { coords: [44.940888662404646, -93.300740130806332], icon: icons.TentIcon, popup: createCampsitePopup('March 16'," "," "," ",'Gandalf advises the leaders to march to Mordor to give the Ring-bearer time to complete his quest.','Minas Tirith'), 
   },
