...
export const gandalfthewhitecampsites = {
  ...
  March3: { coords: [44.9425127,-93.3064040], icon: icons.TentIcon, popup: createCampsitePopup('March 3','?','?','?',`Gandalf tells Theoden to head for Helm's Deep. The Wizard rides to the Fords of Isen to rally the surviving Rohirrim and goes to Isengard to seek help from Treebeard.`, 'Fords of Isen'),
    },
  }
