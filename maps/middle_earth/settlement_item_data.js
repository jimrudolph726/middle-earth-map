...
const iconDefinitions = {
  HobbitsIcon: { file: 'hobbits.png' },
  MenGondorIcon: { file: 'tree_of_gondor.png' },
  MenRohanIcon: { file: 'men_rohan.png' },
  BeaconOfGondorIcon: { file: 'beacon_of_gondor.png' },
  RivendellIcon: { file: 'rivendell.png' },
  LothlorienIcon: { file: 'galadriel.png' },
  MithlondIcon: { file: 'cirdan.png' },
  TentIcon: { file: 'tent.png', size: [30, 30] },
  BattleIcon: { file: 'battles.png' },
  GlamdringIcon: { file: 'glamdring.png' },
  StingIcon: { file: 'sting.png' },
  NarsilIcon: { file: 'narsil.png' },
  RingIcon: { file: 'ring.png' },
  NaryaIcon: { file: 'narya.png' },
  NenyaIcon: { file: 'nenya.png' },
  VilyaIcon: { file: 'vilya.png' },
  BarahirIcon: { file: 'barahir.png' },
  BookIcon: { file: 'book.png' },
  PalantirIcon: { file: 'palantir.png' },
  DwarvesIcon: { file: 'dwarves_durin.png' },
  SauronIcon: { file: 'eye_of_sauron.png' },
  SarumanIcon: { file: 'white_hand_of_saruman.png' },
  WitchkingIcon: { file: 'witchking_of_angmar.png' },
  GoblinIcon: { file: 'goblin.png' },
  MinasMorgulIcon: { file: 'minas_morgul.png' },
  LembasIcon: { file: 'lembas.png' },
...
export const icons = Object.fromEntries(
  Object.entries(iconDefinitions).map(([name, { file, size }]) => [
    name,
    createIcon(new URL(`./assets/${file}`, import.meta.url).href, size),
  ])
);
...
export const enemies = {
  ...
  dul_guldur: {
    popup: createSettlementPopup("Dul Guldur",
    "Stronghold of Sauron in Mordor. Barad-dur was at the end of a long spur of the Ash Mountains on the northern border of Mordor. The tower overlooked the plateau of Gorgoroth.",
