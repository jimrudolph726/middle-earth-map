...
export const samfrodocampsites = {
  ...
  September27: { coords: [44.94651566,-93.31021725], icon: icons.TentIcon, popup: generatePopupContent('September 27'," "," "," d",'Rain.','The House of Tom Bombadil'),
  },
  ...
  January10: { coords: [44.94534782001238, -93.306134824025506], icon: icons.TentIcon, popup: generatePopupContent('January 10',14,17,1.2,'','Foot of Redhorn'),
  },
  January11: { coords: [44.945126912604856, -93.305911886824575], icon: icons.TentIcon, popup: generatePopupContent('January 11',6,8,1.3,'Climb until midnight. Snow.','Redhorn Pass'),
    },
  January12: { coords: [44.945041003939018, -93.306360238306439], icon: icons.TentIcon, popup: generatePopupContent('January 12',8,28,3.5,'March late morning to dusk. Wolf attack at night.','Knoll'),
    },
  January13: { coords: [44.944942822449207, -93.306117484465432], icon: icons.TentIcon, popup: generatePopupContent('January 13',17.5,40,2.3,'Dawn to dusk outside; dusk to after midnight inside Moria.','Guardroom'),
    },
  January14: { coords: [44.944960354870418, -93.305275277261956], icon: icons.TentIcon, popup: generatePopupContent('January 14',8,20,2.5,'Mid-morning to evening march.','Hall Twenty-one'),
    },
  January15: { coords: [44.944697367990038, -93.305022615100896], icon: icons.TentIcon, popup: generatePopupContent('January 15',8,17.5,1.7,'Attack in Moria. Escape.','Flets by Nimrodel'),
    },
  January16: { coords: [44.944713147236826, -93.304750136299774], icon: icons.TentIcon, popup: generatePopupContent('January 16',8,32,4,'Smooth paths.','Central Lorien'),
    },
  January17throughFebruary15: { coords: [44.944655289977362, -93.304467749178613], icon: icons.TentIcon, popup: generatePopupContent('January 17 through February 15',8,32,4,'Cerin Amroth at noon; City after dusk','Caras Galadon'),
    },
  February16: { coords: [44.944379590568801, -93.303939511866389], icon: icons.TentIcon, popup: generatePopupContent('February 16',11.5,35,2.9,'Walk to river; boat afternoon into night.','Woods on west bank'),
    },
  February17: { coords: [44.9441919914861, -93.303652170585195], icon: icons.TentIcon, popup: generatePopupContent('February 17',13,40,3.1,'','West bank'),
    },
  February18: { coords: [44.944093808544231, -93.303270700263596], icon: icons.TentIcon, popup: generatePopupContent('February 18',13,40,3.1,'','Flats north of Celebrant'),
    },
  February19: { coords: [44.943641463535961, -93.303000698542519], icon: icons.TentIcon, popup: generatePopupContent('February 19',13,40,3.1,'','Opposite Brown Lands'),
    },
  February20: { coords: [44.943532759940794, -93.302520145020523], icon: icons.TentIcon, popup: generatePopupContent('February 20',13,55,4.1,'Paddle all day.','Near gravel shoals'),
    },
  February21: { coords: [44.943261000052331, -93.302423538900115], icon: icons.TentIcon, popup: generatePopupContent('February 21',13,55,4.1,'Paddle long spells.','Eyot'),
    },
  February22: { coords: [44.942847221169259, -93.302546154360613], icon: icons.TentIcon, popup: generatePopupContent('February 22',18,70,3.7,'Change to night journey.','Rugged country'),
    },
  February23: { coords: [44.9426732, -93.3025452], icon: icons.TentIcon, popup: generatePopupContent('February 23',4,12,3,'Escape rapids and Orcs.','Bay 0.5 miles N of rapids'),
    },
  February24: { coords: [44.942598251141405, -93.302500328380418], icon: icons.TentIcon, popup: generatePopupContent('February 24'," ",5.4," ",'Portage.','Foot of Rrapids'),
    },
  February25: { coords: [44.942198494206167, -93.302421061820098], icon: icons.TentIcon, popup: generatePopupContent('February 25',11,40,3.6,'Argonath at midafternoon.','Parth Galen'),
    },
  February26: { coords: [44.942226109087123, -93.302224753229297], icon: icons.TentIcon, popup: generatePopupContent('February 26',5,10,2,'1PM to dusk.','Central Eastern Emyn Muil'),
    },
  February27: { coords: [44.942249778974578, -93.301946081728119], icon: icons.TentIcon, popup: generatePopupContent('February 27',12,20,1.7,'Dawk to dusk.','Cliff'),
    },
  February28: { coords: [44.942391798094405, -93.301777021017386], icon: icons.TentIcon, popup: generatePopupContent('February 28',12,20,1.7,'Dawk to dusk.','Hollow'),
    },
  February29: { coords: [44.942590361274824, -93.301580093156531], icon: icons.TentIcon, popup: generatePopupContent('February 29',18,34,1.9,'Dawn to evening.','Feet of Emyn Muil, gully'),
    },
  February30: { coords: [44.942552226677563, -93.301550368196416], icon: icons.TentIcon, popup: generatePopupContent('February 30',16,25,1.6,'Capture Gollum. Brief rest, then walk moonset to dawn.','Northern Dead Marshes'),
    },
  March1: { coords: [44.942498312203725, -93.300872267543525], icon: icons.TentIcon, popup: generatePopupContent('March 1',10,15,1.5,'Dusk to 10 A.M.','SE Dead Marshes'),
    },
  March2: { coords: [44.942364183293073, -93.300731073982917], icon: icons.TentIcon, popup: generatePopupContent('March 2',12,15,1.3,'Dusk to dawn. Stopped for Nazgul.','Noman-lands'),
    },
  March3: { coords: [44.942310268642643, -93.300558297652174], icon: icons.TentIcon, popup: generatePopupContent('March 3',12,15,1.3,'Dusk to dawn.','Edge of Desolation'),
    },
  March4: { coords: [44.942226109087123, -93.300407815041538], icon: icons.TentIcon, popup: generatePopupContent('March 4',8,12,1.5,'Dusk to pre-dawn.','One mile from Morannon'),
    },
  March5: { coords: [44.942222164104933, -93.30027033710094], icon: icons.TentIcon, popup: generatePopupContent('March 5',12,24,2,'Dusk to dawn.','North of Ithilien'),
    },
  March6: { coords: [44.941967054694999, -93.300805386383217], icon: icons.TentIcon, popup: generatePopupContent('March 6',12,24,2,'Dusk to dawn.','Near pool'),
    },
  ...
  March9: { coords: [44.941159639032676, -93.300577804657195], icon: icons.TentIcon, popup: generatePopupContent('March 9',12,22,1.8,'Dawn to dusk.','Morgul-road'),
    },
  March10: { coords: [44.940967646018571, -93.300497918826863], icon: icons.TentIcon, popup: generatePopupContent('March 10',20,22,1.3,'Midnight to dawn in rough terrain. The Dawnless Day. 4 P.M. to dusk. Cross-roads; and all night. Saw Morgul-host.','Just west of Cross-roads'),
    },
  March11: { coords: [44.940955810811758, -93.300332573736156], icon: icons.TentIcon, popup: generatePopupContent('March 11'," "," "," ",'Slept all day and night.','Top of Winding Stair'),
    },
  March12: { coords: [44.940961070903981, -93.300219247325686], icon: icons.TentIcon, popup: generatePopupContent('March 12',27," "," ",'Day and night of March 12, and day of March 13.',"Shelob's Lair"),
    },
  March13throughMarch14: { coords: [44.940967646018571, -93.300039039754893], icon: icons.TentIcon, popup: generatePopupContent('March 13 through March 14'," "," "," ",'Capture by Orcs at dusk.','Frodo - Tower of Cirith Ungol, Sam - Under-way'),
    },
  March15: { coords: [44.941146488846719, -93.299819818173958], icon: icons.TentIcon, popup: generatePopupContent('March 15',13,15,1.2,'Escape from Tower. Walk 5 A.M. to dusk, several halts.','Foot of ravine in Morgai'),
    },
  March16: { coords: [44.941512062894517, -93.30005204442493], icon: icons.TentIcon, popup: generatePopupContent('March 16',24,27,1.1,'Climb Morgai in day; walk in valley all night. Brief rest.','Central valley'),
    },
  March17: { coords: [44.941780324384034, -93.300252687905768], icon: icons.TentIcon, popup: generatePopupContent('March 17',12,25,2.1,'Dusk to dawn.','North end of valley'),
    },
  March18: { coords: [44.94177637937122, -93.299801240073833], icon: icons.TentIcon, popup: generatePopupContent('March 18',9,20,2.3,'Overtaken by Orcs on road.','Near Isenmouthe'),
    },
  March19: { coords: [44.941789529412908, -93.299626605933099], icon: icons.TentIcon, popup: generatePopupContent('March 19',11,10,0.9,'Return to road. Walk early morning to past dusk.','Near road'),
    },
  March20: { coords: [44.941769804349242, -93.299357223481934], icon: icons.TentIcon, popup: generatePopupContent('March 20',12,15,1.3,'Dawn to dusk.','Near road'),
    },
  March21: { coords: [44.941727724190777, -93.299139859711005], icon: icons.TentIcon, popup: generatePopupContent('March 21',12,15,1.3,'Last cistern.','Near road'),
    },
  March22: { coords: [44.941650138817721, -93.299046969210622], icon: icons.TentIcon, popup: generatePopupContent('March 22',12,15,1.3,'Turn south from road. The Dreadful Nightfall','South of road'),
    },
...
export const aragorncampsites = {
  ...
  March03: { coords: [44.942267449196656, -93.305835639205839], icon: icons.TentIcon, popup: generatePopupContent('March 03',13,96,7.4,"Battle of Helm's Deep.","Helm's Deep"), },
  March04: { coords: [44.942841440803193, -93.306437569648423], icon: icons.TentIcon, popup: generatePopupContent('March 04',8,40,5,'4 P.M. to midnight, ride swiftly.','15 miles N of Fords of Isen'), },
  March05: { coords: [44.94283749586328, -93.3064751903011], icon: icons.TentIcon, popup: generatePopupContent('March 05',19,73,3.8,'Ride slowly to Isengard and back. Break camp after Nazgul comes. Late night to dawn. Dunedain join at Fords.',"Dol Baran. Helm's Deep"), },
