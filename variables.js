...
export const samfrodocampsites = {
  ...
  February23: { coords: [44.942598251141405, -93.302500328380418], icon: icons.TentIcon, popup: generatePopupContent('February 23',4,12,3,'Escape rapids and Orcs.','Bay 0.5 miles N of rapids'),
    },
  February24: { coords: [44.942198494206167, -93.302421061820098], icon: icons.TentIcon, popup: generatePopupContent('February 24'," ",5.4," ",'Portage.','Foot of Rrapids'),
    },
  February25: { coords: [44.942226109087123, -93.302224753229297], icon: icons.TentIcon, popup: generatePopupContent('February 25',11,40,3.6,'Argonath at midafternoon.','Parth Galen'),
    },
  February26: { coords: [44.942249778974578, -93.301946081728119], icon: icons.TentIcon, popup: generatePopupContent('February 26',5,10,2,'1PM to dusk.','Central Eastern Emyn Muil'),
    },
  February27: { coords: [44.942391798094405, -93.301777021017386], icon: icons.TentIcon, popup: generatePopupContent('February 27',12,20,1.7,'Dawk to dusk.','Cliff'),
    },
  February28: { coords: [44.942590361274824, -93.301580093156531], icon: icons.TentIcon, popup: generatePopupContent('February 28',12,20,1.7,'Dawk to dusk.','Hollow'),
    },
  February29: { coords: [44.942552226677563, -93.301550368196416], icon: icons.TentIcon, popup: generatePopupContent('February 29',18,34,1.9,'Dawn to evening.','Feet of Emyn Muil, gully'),
    },
  February30: { coords: [44.942498312203725, -93.300872267543525], icon: icons.TentIcon, popup: generatePopupContent('February 30',16,25,1.6,'Capture Gollum. Brief rest, then walk moonset to dawn.','Northern Dead Marshes'),
    },
  March1: { coords: [44.942364183293073, -93.300731073982917], icon: icons.TentIcon, popup: generatePopupContent('March 1',10,15,1.5,'Dusk to 10 A.M.','SE Dead Marshes'),
    },
  March2: { coords: [44.942310268642643, -93.300558297652174], icon: icons.TentIcon, popup: generatePopupContent('March 2',12,15,1.3,'Dusk to dawn. Stopped for Nazgul.','Noman-lands'),
    },
  March3: { coords: [44.942226109087123, -93.300407815041538], icon: icons.TentIcon, popup: generatePopupContent('March 3',12,15,1.3,'Dusk to dawn.','Edge of Desolation'),
    },
  March4: { coords: [44.942222164104933, -93.30027033710094], icon: icons.TentIcon, popup: generatePopupContent('March 4',8,12,1.5,'Dusk to pre-dawn.','One mile from Morannon'),
    },
  March5: { coords: [44.941967054694999, -93.300805386383217], icon: icons.TentIcon, popup: generatePopupContent('March 5',12,24,2,'Dusk to dawn.','North of Ithilien'),
    },
  March6: { coords: [44.941581758364975, -93.300814675433259], icon: icons.TentIcon, popup: generatePopupContent('March 6',12,24,2,'Dusk to dawn.','Near pool'),
    },
  ...
  March7: { coords: [44.941383191733244, -93.300698562307716], icon: icons.TentIcon, popup: generatePopupContent('March 7',2.5,10,4,'Late afternoon to dusk.','Henneth Annun'),
    },
  March8: { coords: [44.941159639032676, -93.300577804657195], icon: icons.TentIcon, popup: generatePopupContent('March 8',12,22,1.8,'Dawn to dusk.','Halfway to Morgul-road'),
    },
  March9: { coords: [44.940967646018571, -93.300497918826863], icon: icons.TentIcon, popup: generatePopupContent('March 9',12,22,1.8,'Dawn to dusk.','Morgul-road'),
    },
  March10: { coords: [44.940955810811758, -93.300332573736156], icon: icons.TentIcon, popup: generatePopupContent('March 10',20,22,1.3,'Midnight to dawn in rough terrain. The Dawnless Day. 4 P.M. to dusk. Cross-roads; and all night. Saw Morgul-host.','Just west of Cross-roads'),
    },
  March11: { coords: [44.940961070903981, -93.300219247325686], icon: icons.TentIcon, popup: generatePopupContent('March 11'," "," "," ",'Slept all day and night.','Top of Winding Stair'),
    },
  March12: { coords: [44.940967646018571, -93.300039039754893], icon: icons.TentIcon, popup: generatePopupContent('March 12',27," "," ",'Day and night of March 12, and day of March 13.',"Shelob's Lair"),
    },
  March13throughMarch14: { coords: [44.941146488846719, -93.299819818173958], icon: icons.TentIcon, popup: generatePopupContent('March 13 through March 14'," "," "," ",'Capture by Orcs at dusk.','Frodo - Tower of Cirith Ungol, Sam - Under-way'),
    },
  March15: { coords: [44.941512062894517, -93.30005204442493], icon: icons.TentIcon, popup: generatePopupContent('March 15',13,15,1.2,'Escape from Tower. Walk 5 A.M. to dusk, several halts.','Foot of ravine in Morgai'),
    },
  March16: { coords: [44.941780324384034, -93.300252687905768], icon: icons.TentIcon, popup: generatePopupContent('March 16',24,27,1.1,'Climb Morgai in day; walk in valley all night. Brief rest.','Central valley'),
    },
  March17: { coords: [44.94177637937122, -93.299801240073833], icon: icons.TentIcon, popup: generatePopupContent('March 17',12,25,2.1,'Dusk to dawn.','North end of valley'),
    },
  March18: { coords: [44.941789529412908, -93.299626605933099], icon: icons.TentIcon, popup: generatePopupContent('March 18',9,20,2.3,'Overtaken by Orcs on road.','Near Isenmouthe'),
    },
  March19: { coords: [44.941769804349242, -93.299357223481934], icon: icons.TentIcon, popup: generatePopupContent('March 19',11,10,0.9,'Return to road. Walk early morning to past dusk.','Near road'),
    },
  March20: { coords: [44.941727724190777, -93.299139859711005], icon: icons.TentIcon, popup: generatePopupContent('March 20',12,15,1.3,'Dawn to dusk.','Near road'),
    },
  March21: { coords: [44.941650138817721, -93.299046969210622], icon: icons.TentIcon, popup: generatePopupContent('March 21',12,15,1.3,'Last cistern.','Near road'),
    },
  March22: { coords: [44.941543623134812, -93.299013528630468], icon: icons.TentIcon, popup: generatePopupContent('March 22',12,15,1.3,'Turn south from road. The Dreadful Nightfall','South of road'),
    },
  March23: { coords: [44.941417382069524, -93.298987519290364], icon: icons.TentIcon, popup: generatePopupContent('March 23',12,10,0.8,'Frodo and Sam cast away their gear. They leave the road and travel south across Gorgoroth toward Mount Doom. They travel by day and rest at night.','Gorgoroth'),
    },
