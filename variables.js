...
export const settlementsData = [
  ...
  { data: Object.fromEntries(
    Object.keys(elves).map(key => [key, createSettlementObjects(elves, key)])), 
...
export const geographicData = [
  {data: Object.fromEntries(
    Object.keys(mountain_range).map(key => [key, createGeographicObjects(mountain_range, key, "orange", 1, 2)])),  
  ...
  {data: Object.fromEntries(
    Object.keys(hill).map(key => [key, createGeographicObjects(hill, key, "red", 1, 2)])),  
