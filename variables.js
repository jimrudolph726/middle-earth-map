...
March05: { coords: [44.942825110515365, -93.306624005896452], icon: icons.TentIcon, popup: generatePopupContent('March 05',6.5,41,6.3,'Ride slowly to Isengard and back. Break camp after Nazgul comes. Late night to dawn ride.',"Dol Baran, Helm's Deep"), },
March06: { coords: [44.941999122267454, -93.305666288234832], icon: icons.TentIcon, popup: generatePopupContent('March 06',5,20,4,'Set out at 1 P.M.','White Mountains'), },
March07: { coords: [44.941847930652827, -93.304941720712094], icon: icons.TentIcon, popup: generatePopupContent('March 07',12,40,3.3,'Mountain Paths','White Mountains'), },
March08: { coords: [44.941904256987172, -93.305360545869746], icon: icons.TentIcon, popup: generatePopupContent('March 08',12,40,3.3,'" "','Pass in White Mountains'), },
March09: { coords: [44.942138548005268, -93.305795600502336], icon: icons.TentIcon, popup: generatePopupContent('March 09',12,40,3.3,'" "','Dunharrow'), },
March10: { coords: [44.941927973321931, -93.304336518359335], icon: icons.TentIcon, popup: generatePopupContent('March 10',9,56,6.2,'The Dawnless Day. Leave Dunharrow at 9 A.M.; muster in Edoras at noon.','Willow Wood'), },
March11: { coords: [44.941286146557317, -93.302550229062021], icon: icons.TentIcon, popup: generatePopupContent('March 11',12,80,6.7,'Ride dawn to dusk.','Firien Wood'), },
March12: { coords: [44.941217961306215, -93.30168535511153], icon: icons.TentIcon, popup: generatePopupContent('March 12',12,80,6.7,'Dawn to dusk.','Minrimmon'), },
March13: { coords: [44.941148293683398, -93.301279094708633], icon: icons.TentIcon, popup: generatePopupContent('March 13',12,80,6.7,'Dawn to dusk.','Druadan Forest'), },
March14: { coords: [44.940908162080305, -93.301197423802904], icon: icons.TentIcon, popup: generatePopupContent('March 14',10,50,5,'Stonewain Valley.','Grey Wood'), },
March15: { coords: [44.941592811896278, -93.303756899969343], icon: icons.TentIcon, popup: generatePopupContent('March 15',3.5,24.5,7,'Reach Rammas at dawn.  Battle of the Pelennor Fields','Minas Tirith'), },
}
